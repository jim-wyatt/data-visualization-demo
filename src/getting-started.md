...
- [Installation](./installation.md) — detailed install instructions by platform.
- [Running the Notebook](./running-notebook.md) — how to start Jupyter and open the notebook.
